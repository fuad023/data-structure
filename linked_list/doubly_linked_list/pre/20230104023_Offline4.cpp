...
int main()
{
    ...
    list.insert_ref_value(5, 10);
    list.insert_at_pos(45, 5);
    list.print_forward(); // 5 10 20 40 45 50

    list.delete_first();
    list.delete_last();
    list.print_forward(); // 10 20 40 45

    list.delete_ref_value(40);
    list.delete_at_pos(2);
    list.print_forward(); // 10 45
    list.print_backward(); // 45 10

    cout << (list.search_node(45) ? "Found" : "Not Found") << '\n';

    list.print_last(); // 45
    list.print_second_last(); // 10
